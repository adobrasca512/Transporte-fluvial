...
private Vector<Mercancias> mercancias;
...
public Vector<Mercancias> getMercancias() {
	return mercancias;
}
public void setMercancias(Vector<Mercancias> mercancias) {
	this.mercancias = mercancias;
}
public Vector<Persona> getPersonas() {
	return personas;
}
public void setPersonas(Vector<Persona> personas) {
	this.personas = personas;
}
